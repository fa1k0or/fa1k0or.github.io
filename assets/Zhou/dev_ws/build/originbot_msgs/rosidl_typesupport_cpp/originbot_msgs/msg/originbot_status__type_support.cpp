...
static const _OriginbotStatus_type_support_symbol_names_t _OriginbotStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, originbot_msgs, msg, OriginbotStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, originbot_msgs, msg, OriginbotStatus)),
  }
};
...
{
  return &::originbot_msgs::msg::rosidl_typesupport_cpp::OriginbotStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, originbot_msgs, msg, OriginbotStatus)() {
  return get_message_type_support_handle<originbot_msgs::msg::OriginbotStatus>();
}
