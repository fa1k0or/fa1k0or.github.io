...
{
  originbot_msgs__srv__OriginbotLed_Request * msg = (originbot_msgs__srv__OriginbotLed_Request *)malloc(sizeof(originbot_msgs__srv__OriginbotLed_Request));
  if (!msg) {
    return NULL;
  }
...
originbot_msgs__srv__OriginbotLed_Request__Sequence__init(originbot_msgs__srv__OriginbotLed_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (originbot_msgs__srv__OriginbotLed_Request *)calloc(size, sizeof(originbot_msgs__srv__OriginbotLed_Request));
    if (!data) {
      return false;
    }
...
{
  originbot_msgs__srv__OriginbotLed_Request__Sequence * array = (originbot_msgs__srv__OriginbotLed_Request__Sequence *)malloc(sizeof(originbot_msgs__srv__OriginbotLed_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  originbot_msgs__srv__OriginbotLed_Response * msg = (originbot_msgs__srv__OriginbotLed_Response *)malloc(sizeof(originbot_msgs__srv__OriginbotLed_Response));
  if (!msg) {
    return NULL;
  }
...
originbot_msgs__srv__OriginbotLed_Response__Sequence__init(originbot_msgs__srv__OriginbotLed_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (originbot_msgs__srv__OriginbotLed_Response *)calloc(size, sizeof(originbot_msgs__srv__OriginbotLed_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  originbot_msgs__srv__OriginbotLed_Response__Sequence * array = (originbot_msgs__srv__OriginbotLed_Response__Sequence *)malloc(sizeof(originbot_msgs__srv__OriginbotLed_Response__Sequence));
  if (!array) {
    return NULL;
  }
