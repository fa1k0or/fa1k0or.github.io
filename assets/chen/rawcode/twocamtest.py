...
cap1 = cv2.VideoCapture(0) #change number if wrong camera
        ...
        with mp_hands.Hands(
            ...
            while True:
                ...
                for hand in allhands:
                    print(getcamdistance(getdistance(hand)),'1')
                ...
                #get HL2s
                for hand in allhands:
                    print(getcamdistance(getdistance(hand)),'2')
                ...
                cv2.waitKey(20) #give passing time for memory (33 milisecs means 30fps, 1000/30 = 33.33333333333336)
